            ...
            <div className="relative flex items-center justify-between h-16">
              ...
              <div className="flex-1 flex items-center justify-end sm:items-stretch sm:justify-between">
                <div className="flex-shrink-0 flex items-center">
                  <Link href="/">
                    <Image
                      className="block lg:hidden h-12 w-auto text-white cursor-pointer"
                      src="/logoOut.png"
                      alt="Builders Ark"
                      width={90}
                      height={37}
                ...
                <div className="hidden justify-self-end  sm:block sm:ml-6">
                  <div className="flex space-x-4">
                    ...
                    <Link href="/contacts">
                      <a className="text-white bg-primary text-xs p-2 rounded">
                        Get a Quote
                      </a>
                    </Link>
                  </div>
